...
**1. Semantic Linking.** Documentation sections are linked to source code declarations to establish functional semantics — the project-specific meaning of each declaration. This step is the bridge between documentation and code, and it runs before requirement and behavior extraction so that they can be generated with business-level meaning rather than assumed meanings or purely mechanical descriptions.
